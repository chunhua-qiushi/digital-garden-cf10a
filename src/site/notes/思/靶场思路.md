---
{"dg-publish":true,"permalink":"/思/靶场思路/"}
---
...
[[tips/shell和提权#一句话木马\|shell和提权#一句话木马]]
## 连接成功 进入系统
...
### 先看看80端口有什么东西
登录界面 可以试试sql注入 用万能密码[[tips/shell和提权#sql万能密码\|shell和提权#sql万能密码]]试试 加上账户名是john 可以登进去 知道了密码
...
## 提权
### 1. mysql提权
[[tips/shell和提权#mysql的udf逃逸\|shell和提权#mysql的udf逃逸]]
```
...
## wuff
[[tips/linux工具#wfuff\|linux工具#wfuff]]
这个确实没接触过 不了解流程
...
-s 6767                 # 目标服务端口
```
[[tips/linux工具#^995249\|linux工具#^995249]]

[[tips/linux工具#^71d08f\|linux工具#^71d08f]]
...
```
[[tips/shell和提权#^5af79a\|shell和提权#^5af79a]]
...
```
[[tips/linux工具#^9335c2\|linux工具#^9335c2]]
...
写一个shell.php进去
[[tips/shell和提权#^3a4f50\|shell和提权#^3a4f50]]
...
```
[[tips/linux工具#^59efba\|linux工具#^59efba]]

[[tips/linux工具#^bf5ac4\|linux工具#^bf5ac4]]
...
```
[[tips/shell和提权#^0be5ac\|shell和提权#^0be5ac]]
...
[[思/Lord Of The Root 1.0.1\|Lord Of The Root 1.0.1]]
## nmap扫描端口
...
# Year of the Owl(思)
#windows 
[[思/Year of the Owl\|Year of the Owl]]
## nmap扫描端口
...
这个是个要点 意思就是可以高权限运行msi[[思/cyberlens#注册表键值的作用​​\|cyberlens#注册表键值的作用​​]]
...
#  Hack Me Please
[[思/Hack Me Please\|Hack Me Please]]
## nmap 爆破端口
...
登录 smtp 服务发送邮件
[[tips/shell和提权#smtp 邮件木马\|shell和提权#smtp 邮件木马]]
```
MAIL FROM: test
RCPT TO: helios
data
...
检查发现权限挺高的
#### linux 环境变量劫持
[[tips/shell和提权#linux 环境变量劫持\|shell和提权#linux 环境变量劫持]]
```
cd /tmp
echo "/bin/sh" > curl
chmod 777 curl
...
依旧环境变量劫持
[[tips/shell和提权#^2b355a\|shell和提权#^2b355a]]  新一代
```
...
[[思/Digitalworld. local (Development)\|Digitalworld. local (Development)]]
## nmap 扫描端口
