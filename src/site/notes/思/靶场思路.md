...
[[tips和一些工具/shell和提权#一句话木马\|shell和提权#一句话木马]]
## 连接成功 进入系统
...
[[tips和一些工具/shell和提权#用过的交互式\|shell和提权#用过的交互式]]

os.execute("/bin/sh") 的作用是启动一个 ​​子进程 Shell 环境​​，其权限 ​​完全继承自父进程​​ 意思就是我们这个终端就可以继承到root权限 
[[tips和一些工具/shell和提权#^abc63a\|shell和提权#^abc63a]]
...
### 先看看80端口有什么东西
登录界面 可以试试sql注入 用万能密码[[tips和一些工具/shell和提权#sql万能密码\|shell和提权#sql万能密码]]试试 加上账户名是john 可以登进去 知道了密码
...
## 提权
### 1. mysql提权
[[tips和一些工具/shell和提权#mysql的udf逃逸\|shell和提权#mysql的udf逃逸]]
```
...
[[tips和一些工具/linux工具#^71d08f\|linux工具#^71d08f]]
...
```
[[tips和一些工具/shell和提权#^5af79a\|shell和提权#^5af79a]]
...
写一个shell.php进去
[[tips和一些工具/shell和提权#^3a4f50\|shell和提权#^3a4f50]]
...
```
[[tips和一些工具/shell和提权#^0be5ac\|shell和提权#^0be5ac]]
...
登录 smtp 服务发送邮件
[[tips和一些工具/shell和提权#smtp 邮件木马\|shell和提权#smtp 邮件木马]]
```
MAIL FROM: test
RCPT TO: helios
data
...
检查发现权限挺高的
#### linux 环境变量劫持
[[tips和一些工具/shell和提权#linux 环境变量劫持\|shell和提权#linux 环境变量劫持]]
```
cd /tmp
echo "/bin/sh" > curl
chmod 777 curl
...
依旧环境变量劫持
[[tips和一些工具/shell和提权#^2b355a\|shell和提权#^2b355a]]  新一代
```
